...
class DataSet():
    def __init__(self, class_limit=None, image_shape=(224, 224), original_image_shape=(341, 256), n_snip=5, opt_flow_len=10, batch_size=16):
        ...
        self.static_frame_path = os.path.join('D:/autism/combine_S_T', '')
        self.opt_flow_path = os.path.join('D:/autism/combine_S_T', '')
    ...
    def get_data_list():
        ...
        with open(os.path.join('D:/autism/two-stream-action-recognition-keras-master', 'data_autism.csv'), 'r') as fin:
    ...
    def get_static_frame(self, row):
        ...
        opt_flow_dir_x = os.path.join(self.opt_flow_path, row[2])
        opt_flow_dir_y = os.path.join(self.opt_flow_path, row[2])
