...
def run_test():
  ...
  batch_size =10 
  model_name = "D:/autism/c3d_ucf101_finetune_whole_iter_20000_TF.model"
  ...
  for gpu_index in range(0, gpu_num):
    with tf.device('/gpu:%d' % gpu_index):
      logit = c3d_model.inference_c3d(images_placeholder[gpu_index * batch_size:(gpu_index + 1) * batch_size,:,:,:,:], 0.6, batch_size, weights, biases)
      logits.append(logit)
