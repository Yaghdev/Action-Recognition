...
def run_test():
    init_path = '/home/ankur/data/new_disk/new_3d_output/'
    if True:
        model_name = init_path+'c3d_ucf_model-2520/c3d_ucf_model-2520'
        test_list_file = '/home/ankur/data/new_disk/C3D-tensorflow/list/train_new.list'
        ...
        bufsize = 0
        write_file = open("/home/ankur/data/new_disk/C3D-tensorflow/test_results/predict_3.txt", "w+")
        next_start_pos = -1
